...
![oracle-server](https://img.shields.io/badge/oracle--server-v1.5.0-blue.svg)
...
| UI & 样式 | [![Color Mode](https://img.shields.io/badge/Color%20Mode-3.3.2-blue.svg)](https://color-mode.nuxtjs.org/) | [![MDI](https://img.shields.io/badge/Material%20Design%20Icons-7.3.67-2196F3.svg)](https://pictogrammers.com/library/mdi/) |
| :-------: | :-------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------: |
